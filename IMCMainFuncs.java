...
public class IMCMainFuncs extends JFrame implements ActionListener{
   ...
   private final Font font1 = new Font("Agency FB", Font.BOLD, 20);//Esta es la fuente que use
     ...
     public IMCMainFuncs(){
         ...
         title.setBounds(140,0,500,60);
         title.setFont( new Font("Agency FB", Font.BOLD, 40) );
         title.setForeground(Color.black);
         this.add(title);
         
         //Este label nos pide el peso
         labelPeso = new JLabel("Ingresa tu peso en libras");
         labelPeso.setBounds(165,120,200,30);
         ...
         fieldPeso.setBounds(140,150,200,30);
         fieldPeso.setFont(font1);
         fieldPeso.setForeground(Color.black);
         this.add(fieldPeso);
         
         //Este JLabel nos pide la altura
         labelAltura = new JLabel("Ingresa tu altura en metros");
         labelAltura.setBounds(160,220,200,30);
         ...
         fieldAltura.setBounds(140,250,200,30);
         ...
         botonCalcular.setBounds(190,330,100,30);
         ...
         labelIMC.setBounds(120,380,200,30);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if(e.getSource() == botonCalcular){
           ...
           if( IMC < 18.5 ){
               ...
               title.setBounds(130,0,500,60);
           }
           else if( IMC >26 && IMC<30 ){
               title.setText("Tienes preobesidad");
               this.getContentPane().setBackground(Color.pink);
               title.setBounds(115,0,500,60);
           }
           else if( IMC>30 ){
               title.setText("Tienes obesidad");
               this.getContentPane().setBackground(Color.red);
               title.setBounds(135,0,500,60);
           }
           else{
